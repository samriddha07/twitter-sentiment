...
access_token_secret = 'HGUXfSqklXnzHc4AzxC9o9FsLWzi3frznNa4ZtLCE1XJJ'
...
def app():
    ...
    st.markdown("""Created by : Samriddha Bajpai  """)
    st.write(
    ...
    st.write(
        "All results are based on the number of Latest Tweets selected on the Sidebar."
    )
    ...
    if user_name != "" and tweet_count > 0:
        ...
        st.info(
            ":point_left: Enter the Twitter Handle & Number of Tweets to Analyze on the SideBar"
        )
